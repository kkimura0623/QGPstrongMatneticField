...
subroutine photon_propagator(Prop,PP,A,r,n0,n1,n2,qmom,eB,pol_type,particle_type,status)
!
...
!
  ...
  complex(DP), intent(out) :: PP(0:NDIM-1,0:NDIM-1)
  complex(DP), intent(out) :: A(NDIM,NDIM)
  complex(DP), intent(out) :: n0,n1,n2
  ...
  complex(DP) :: B(NDIM,NDIM)
  complex(DP) :: TT(0:NDIM-1,0:NDIM-1)
  complex(DP) :: n0_0,n1_0,n2_0
  ...
  case(PARTICLES_ELECTRON)
    ...
    !-------------------------------------
    call photon_vaccum_polarization_tensor(TT,r_0,n0_0,n1_0,n2_0,qmom,eB,MASS_ELECTRON)
  ...
  case(PARTICLES_MUON)
    ...
    !-------------------------------------
    call photon_vaccum_polarization_tensor(TT,r_0,n0_0,n1_0,n2_0,qmom,eB,MASS_MUON)
...
subroutine photon_vaccum_polarization_tensor(Tensor,r,n0,n1,n2,qmom,eB,mass)
!
...
subroutine formfactor00(qmom,eB,mass,r,cn0,cn1,cn2,rn0,rn1,rn2)
  use physics_constsnt_mod
  implicit none
   real(DP),    intent(in)    :: qmom(0:NDIM-1)
   real(DP),    intent(in)    :: eB, mass
   real(DP),    intent(in)    :: r
   complex(DP), intent(out) :: cn0,cn1,cn2
   integer :: i,j
   real(DP), intent(out) :: rn0,rn1,rn2
   real(DP) :: rtmp0,rtmp1
   real(DP) :: mu,q
...
subroutine formfactor01(qmom,eB,r,cn0,cn1,cn2,rn0,rn1,rn2,particle01_type,status)
use physics_constsnt_mod
implicit none
  real(DP),    intent(in)  :: qmom(0:NDIM-1)
  real(DP),    intent(in)  :: eB
  real(DP) :: r_0,rn0_0,rn1_0,rn2_0
  integer, optional, intent(in)  :: particle01_type
  integer, optional, intent(out) :: status(2)
  complex(DP) :: A(NDIM,NDIM),B(NDIM,NDIM)
  complex(DP) :: cn0_0,cn1_0,cn2_0
  integer, parameter :: LWORK=NDIM*NDIM*2
  integer :: IPIV(NDIM),INFO
  integer :: i,j 
  complex(DP) :: WORK(LWORK)
  real(DP), intent(out) :: rn0,rn1,rn2,r
  complex(DP), intent(out) :: cn0,cn1,cn2

  select case(m_particle_type)
  case(PARTICLES_ELECTRON)
  call formfactor00(qmom,eB,MASS_ELECTRON,r_0,cn0_0,cn1_0,cn2_0,rn0_0,rn1_0,rn2_0)
  r = r_0
  cn0 = cn0_0
  cn1 = cn1_0
  cn2 = cn2_0
  ...
  rn2 = rn2_0
  case(PARTICLES_MUON)
  call formfactor00(qmom,eB,MASS_MUON,r_0,cn0_0,cn1_0,cn2_0,rn0_0,rn1_0,rn2_0)
  r = r_0
  cn0 = cn0_0
  cn1 = cn1_0
  cn2 = cn2_0
